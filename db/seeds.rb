...
GroupMember.create!(user_id: 2, group_id: 4, group_type: "organization", role: "member", confirm: false)
GroupMember.create!(user_id: 3, group_id: 4, group_type: "organization", role: "member", confirm: false)
GroupMember.create!(user_id: 5, group_id: 4, group_type: "organization", role: "member", confirm: false)
